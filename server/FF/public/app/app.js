...
app.controller('page', ['$rootScope', '$scope', '$http', '$modal', '$location', '$window', function ($rootScope, $scope,  $http, $modal, $location, $window) {

    $scope.setSessionToken = function(token) {
        $window.sessionStorage.sessionToken = token;
    };

    $scope.getSessionToken = function() {
        return $window.sessionStorage.sessionToken;
    };

    $scope.removeSessionToken = function() {
